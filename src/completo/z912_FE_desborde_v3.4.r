...
AgregarVariables  <- function( )
{
  ...
  dataset[ , auto_tarj_all_vs_debtrx_prom_all := auto_tarj_all / debtrx_prom_all]
  dataset[ , auto_tarj_all_vs_mctacorr_vs_mcajaho := auto_tarj_all / mctacorr_vs_mcajaho]
  dataset[ , auto_tarj_all_vs_cpayroll_trx := auto_tarj_all / cpayroll_trx]
  dataset[ , auto_tarj_all_vs_mdescubierto_preacordado := auto_tarj_all / mdescubierto_preacordado]
  dataset[ , auto_tarj_all_vs_ctrx_quarter_normalizado := auto_tarj_all / ctrx_quarter_normalizado]
  dataset[ , auto_tarj_all_vs_mcaja_ahorro := auto_tarj_all / mcaja_ahorro]
  dataset[ , auto_tarj_all_vs_mcuentas_saldo := auto_tarj_all / mcuentas_saldo]
  dataset[ , auto_tarj_all_vs_monto_cred := auto_tarj_all / monto_cred]
  dataset[ , auto_tarj_all_vs_prom_cajaho := auto_tarj_all / prom_cajaho]
  dataset[ , auto_tarj_all_vs_foto_mes := auto_tarj_all / foto_mes]
  dataset[ , auto_tarj_all_vs_Visa_Finiciomora := auto_tarj_all / Visa_Finiciomora]
  dataset[ , auto_tarj_all_vs_ctarjeta_visa_trx := auto_tarj_all / ctarjeta_visa_trx]
  dataset[ , auto_tarj_all_vs_payrolltotal_vs_edad := auto_tarj_all / payrolltotal_vs_edad]
  dataset[ , auto_tarj_all_vs_mprestamos_ctrx_quarter := auto_tarj_all / ctrx_quarter]

  dataset[ , mctacorr_vs_mcajaho_vs_cpayroll_trx := mctacorr_vs_mcajaho / cpayroll_trx]
  dataset[ , mctacorr_vs_mcajaho_vs_mdescubierto_preacordado := mctacorr_vs_mcajaho / mdescubierto_preacordado]
  dataset[ , mctacorr_vs_mcajaho_vs_ctrx_quarter_normalizado := mctacorr_vs_mcajaho / ctrx_quarter_normalizado]
  dataset[ , mctacorr_vs_mcajaho_vs_mcaja_ahorro := mctacorr_vs_mcajaho / mcaja_ahorro]
  dataset[ , mctacorr_vs_mcajaho_vs_mcuentas_saldo := mctacorr_vs_mcajaho / mcuentas_saldo]
  dataset[ , mctacorr_vs_mcajaho_vs_monto_cred := mctacorr_vs_mcajaho / monto_cred]
  dataset[ , mctacorr_vs_mcajaho_vs_prom_cajaho := mctacorr_vs_mcajaho / prom_cajaho]
  dataset[ , mctacorr_vs_mcajaho_vs_foto_mes := mctacorr_vs_mcajaho / foto_mes]
  dataset[ , mctacorr_vs_mcajaho_vs_Visa_Finiciomora := mctacorr_vs_mcajaho / Visa_Finiciomora]
  dataset[ , mctacorr_vs_mcajaho_vs_ctarjeta_visa_trx := mctacorr_vs_mcajaho / ctarjeta_visa_trx]
  dataset[ , mctacorr_vs_mcajaho_vs_payrolltotal_vs_edad := mctacorr_vs_mcajaho / payrolltotal_vs_edad]
  dataset[ , mctacorr_vs_mcajaho_vs_mprestamos_ctrx_quarter := mctacorr_vs_mcajaho / ctrx_quarter]
  
  dataset[ , cpayroll_trx_vs_mdescubierto_preacordado := cpayroll_trx / mdescubierto_preacordado]
  dataset[ , cpayroll_trx_vs_ctrx_quarter_normalizado := cpayroll_trx / ctrx_quarter_normalizado]
  dataset[ , cpayroll_trx_vs_mcaja_ahorro := cpayroll_trx / mcaja_ahorro]
  dataset[ , cpayroll_trx_vs_mcuentas_saldo := cpayroll_trx / mcuentas_saldo]
  dataset[ , cpayroll_trx_vs_monto_cred := cpayroll_trx / monto_cred]
  dataset[ , cpayroll_trx_vs_prom_cajaho := cpayroll_trx / prom_cajaho]
  dataset[ , cpayroll_trx_vs_foto_mes := cpayroll_trx / foto_mes]
  dataset[ , cpayroll_trx_vs_Visa_Finiciomora := cpayroll_trx / Visa_Finiciomora]
  dataset[ , cpayroll_trx_vs_ctarjeta_visa_trx := cpayroll_trx / ctarjeta_visa_trx]
  dataset[ , cpayroll_trx_vs_payrolltotal_vs_edad := cpayroll_trx / payrolltotal_vs_edad]
  dataset[ , cpayroll_trx_vs_mprestamos_ctrx_quarter := cpayroll_trx / ctrx_quarter]
  
  dataset[ , mdescubierto_preacordado_vs_ctrx_quarter_normalizado := mdescubierto_preacordado / ctrx_quarter_normalizado]
  dataset[ , mdescubierto_preacordado_vs_mcaja_ahorro := mdescubierto_preacordado / mcaja_ahorro]
  dataset[ , mdescubierto_preacordado_vs_mcuentas_saldo := mdescubierto_preacordado / mcuentas_saldo]
  dataset[ , mdescubierto_preacordado_vs_monto_cred := mdescubierto_preacordado / monto_cred]
  dataset[ , mdescubierto_preacordado_vs_prom_cajaho := mdescubierto_preacordado / prom_cajaho]
  dataset[ , mdescubierto_preacordado_vs_foto_mes := mdescubierto_preacordado / foto_mes]
  dataset[ , mdescubierto_preacordado_vs_Visa_Finiciomora := mdescubierto_preacordado / Visa_Finiciomora]
  dataset[ , mdescubierto_preacordado_vs_ctarjeta_visa_trx := mdescubierto_preacordado / ctarjeta_visa_trx]
  dataset[ , mdescubierto_preacordado_vs_payrolltotal_vs_edad := mdescubierto_preacordado / payrolltotal_vs_edad]
  dataset[ , mdescubierto_preacordado_vs_mprestamos_ctrx_quarter := mdescubierto_preacordado / ctrx_quarter]
  
  dataset[ , ctrx_quarter_normalizado_vs_mcaja_ahorro := ctrx_quarter_normalizado / mcaja_ahorro]
  dataset[ , ctrx_quarter_normalizado_vs_mcuentas_saldo := ctrx_quarter_normalizado / mcuentas_saldo]
  dataset[ , ctrx_quarter_normalizado_vs_monto_cred := ctrx_quarter_normalizado / monto_cred]
  dataset[ , ctrx_quarter_normalizado_vs_prom_cajaho := ctrx_quarter_normalizado / prom_cajaho]
  dataset[ , ctrx_quarter_normalizado_vs_foto_mes := ctrx_quarter_normalizado / foto_mes]
  dataset[ , ctrx_quarter_normalizado_vs_Visa_Finiciomora := ctrx_quarter_normalizado / Visa_Finiciomora]
  dataset[ , ctrx_quarter_normalizado_vs_ctarjeta_visa_trx := ctrx_quarter_normalizado / ctarjeta_visa_trx]
  dataset[ , ctrx_quarter_normalizado_vs_payrolltotal_vs_edad := ctrx_quarter_normalizado / payrolltotal_vs_edad]
  dataset[ , ctrx_quarter_normalizado_vs_mprestamos_ctrx_quarter := ctrx_quarter_normalizado / ctrx_quarter]
  
  dataset[ , mcaja_ahorro_vs_mcuentas_saldo := mcaja_ahorro / mcuentas_saldo]
  dataset[ , mcaja_ahorro_vs_monto_cred := mcaja_ahorro / monto_cred]
  dataset[ , mcaja_ahorro_vs_prom_cajaho := mcaja_ahorro / prom_cajaho]
  dataset[ , mcaja_ahorro_vs_foto_mes := mcaja_ahorro / foto_mes]
  dataset[ , mcaja_ahorro_vs_Visa_Finiciomora := mcaja_ahorro / Visa_Finiciomora]
  dataset[ , mcaja_ahorro_vs_ctarjeta_visa_trx := mcaja_ahorro / ctarjeta_visa_trx]
  dataset[ , mcaja_ahorro_vs_payrolltotal_vs_edad := mcaja_ahorro / payrolltotal_vs_edad]
  dataset[ , mcaja_ahorro_vs_mprestamos_ctrx_quarter := mcaja_ahorro / ctrx_quarter]
  
  dataset[ , mcuentas_saldo_vs_monto_cred := mcuentas_saldo / monto_cred]
  dataset[ , mcuentas_saldo_vs_prom_cajaho := mcuentas_saldo / prom_cajaho]
  dataset[ , mcuentas_saldo_vs_foto_mes := mcuentas_saldo / foto_mes]
  dataset[ , mcuentas_saldo_vs_Visa_Finiciomora := mcuentas_saldo / Visa_Finiciomora]
  dataset[ , mcuentas_saldo_vs_ctarjeta_visa_trx := mcuentas_saldo / ctarjeta_visa_trx]
  dataset[ , mcuentas_saldo_vs_payrolltotal_vs_edad := mcuentas_saldo / payrolltotal_vs_edad]
  dataset[ , mcuentas_saldo_vs_mprestamos_ctrx_quarter := mcuentas_saldo / ctrx_quarter]
  
  dataset[ , monto_cred_vs_prom_cajaho := monto_cred / prom_cajaho]
  dataset[ , monto_cred_vs_foto_mes := monto_cred / foto_mes]
  dataset[ , monto_cred_vs_Visa_Finiciomora := monto_cred / Visa_Finiciomora]
  dataset[ , monto_cred_vs_ctarjeta_visa_trx := monto_cred / ctarjeta_visa_trx]
  dataset[ , monto_cred_vs_payrolltotal_vs_edad := monto_cred / payrolltotal_vs_edad]
  dataset[ , monto_cred_vs_mprestamos_ctrx_quarter := monto_cred / ctrx_quarter]
  
  dataset[ , prom_cajaho_vs_foto_mes := prom_cajaho / foto_mes]
  dataset[ , prom_cajaho_vs_Visa_Finiciomora := prom_cajaho / Visa_Finiciomora]
  dataset[ , prom_cajaho_vs_ctarjeta_visa_trx := prom_cajaho / ctarjeta_visa_trx]
  dataset[ , prom_cajaho_vs_payrolltotal_vs_edad := prom_cajaho / payrolltotal_vs_edad]
  dataset[ , prom_cajaho_vs_mprestamos_ctrx_quarter := prom_cajaho / ctrx_quarter]
  
  dataset[ , foto_mes_vs_Visa_Finiciomora := foto_mes / Visa_Finiciomora]
  dataset[ , foto_mes_vs_ctarjeta_visa_trx := foto_mes / ctarjeta_visa_trx]
  dataset[ , foto_mes_vs_payrolltotal_vs_edad := foto_mes / payrolltotal_vs_edad]
  dataset[ , foto_mes_vs_mprestamos_ctrx_quarter := foto_mes / ctrx_quarter]
  
  dataset[ , Visa_Finiciomora_vs_ctarjeta_visa_trx := Visa_Finiciomora / ctarjeta_visa_trx]
  dataset[ , Visa_Finiciomora_vs_payrolltotal_vs_edad := Visa_Finiciomora / payrolltotal_vs_edad]
  dataset[ , Visa_Finiciomora_vs_mprestamos_ctrx_quarter := Visa_Finiciomora / ctrx_quarter]
  
  dataset[ , ctarjeta_visa_trx_vs_payrolltotal_vs_edad := ctarjeta_visa_trx / payrolltotal_vs_edad]
  dataset[ , ctarjeta_visa_trx_vs_mprestamos_ctrx_quarter := ctarjeta_visa_trx / ctrx_quarter]
  
  dataset[ , payrolltotal_vs_edad_vs_mprestamos_ctrx_quarter := payrolltotal_vs_edad / ctrx_quarter]
