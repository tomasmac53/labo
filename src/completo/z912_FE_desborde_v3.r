...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , actividad_en_caja          := rowSums( cbind( ccajas_trxm, ccajas_consultas, ccajas_depositos, ccajas_otras, ccajas_extracciones) , na.rm=TRUE ) ]
  ...
  dataset[ , prom_payroll2 := mpayroll2 / cpayroll_trx2 ]
  ...
  dataset[ , prom_pagoserv := mpagoserv / cpagoserv ]
  dataset[ , prom_pagomisc := mpagomiscuentas / cpagosmiscuentas ]
  ...
  dataset[ , cliente_edad_1 := ifelse( dataset$cliente_edad < 21, "0-20",
                                       ifelse(dataset$cliente_edad < 31, "21-30",
                                              ifelse(dataset$cliente_edad < 41, "31-40",
                                                     ifelse(dataset$cliente_edad < 51, "41-50",
                                                            ifelse(dataset$cliente_edad < 61, "51-60",
                                                                   ifelse(dataset$cliente_edad < 71, "61-70",
                                                                          ifelse(dataset$cliente_edad < 81, "71-80",
                                                                                 ifelse(dataset$cliente_edad < 91, "81-90",
                                                                                        "91-100")))))))) ]

  dataset[ , cliente_edad_2 := ifelse( dataset$cliente_edad < 21, "0-20",
                                       ifelse(dataset$cliente_edad < 36, "21-35",
                                              ifelse(dataset$cliente_edad < 51, "36-50",
                                                     ifelse(dataset$cliente_edad < 66, "61-65",
                                                            ifelse(dataset$cliente_edad < 81, "66-80",
                                                                   ifelse(dataset$cliente_edad < 96, "81-95",
                                                                                        "91-100")))))) ]
  
  dataset[ , cliente_edad_3 := ifelse( dataset$cliente_edad < 21, "0-20",
                                       ifelse(dataset$cliente_edad < 41, "21-40",
                                              ifelse(dataset$cliente_edad < 61, "41-60",
                                                     ifelse(dataset$cliente_edad < 81, "61-80",
                                                                          "81-100"))))]
  
  dataset[ , cliente_edad_4 := ifelse( dataset$cliente_edad < 26, "0-25",
                                       ifelse(dataset$cliente_edad < 51, "26-50",
                                              ifelse(dataset$cliente_edad < 76, "51-75",
                                                            "75-100")))]
 
  dataset[ , cliente_antig_1 := ifelse( dataset$cliente_antiguedad < 51, "0-50",
                                       ifelse(dataset$cliente_antiguedad < 101, "51-100",
                                              ifelse(dataset$cliente_antiguedad < 151, "101-150",
                                                     ifelse(dataset$cliente_antiguedad < 201, "151-200",
                                                            ifelse(dataset$cliente_antiguedad < 251, "201-250",
                                                                   ifelse(dataset$cliente_antiguedad < 301, "251-300",
                                                                          ifelse(dataset$cliente_antiguedad < 351, "301-350",
                                                                                 "351-400")))))))]
  
  dataset[ , cliente_antig_2 := ifelse( dataset$cliente_antiguedad < 101, "0-100",
                                       ifelse(dataset$cliente_antiguedad < 201, "101-200",
                                              ifelse(dataset$cliente_antiguedad < 301, "201-300",
                                                     "301-400")))]  
  
  dataset[ , cliente_antig_3 := ifelse( dataset$cliente_antiguedad < 151, "0-150",
                                       ifelse(dataset$cliente_antiguedad < 301, "151-300",
                                              "301-450"))]
  ...
  dataset[ , suma_paq := tpaquete2 + tpaquete3 + tpaquete4 + tpaquete9]
  dataset[ , mult_paq := tpaquete2 * tpaquete3 * tpaquete4 * tpaquete9]
  dataset[ , suma_paq_2_3 := tpaquete2 + tpaquete3]
  dataset[ , suma_paq_2_4 := tpaquete2 + tpaquete4]
  dataset[ , suma_paq_2_9 := tpaquete2 + tpaquete9]
  dataset[ , suma_paq_3_4 := tpaquete4 + tpaquete3]
  dataset[ , suma_paq_3_9 := tpaquete3 + tpaquete9]
  dataset[ , suma_paq_4_9 := tpaquete4 + tpaquete9]
  dataset[ , mult_paq_2_3 := tpaquete2 * tpaquete3]
  dataset[ , mult_paq_2_4 := tpaquete2 * tpaquete4]
  dataset[ , mult_paq_2_9 := tpaquete2 * tpaquete9]
  dataset[ , mult_paq_3_4 := tpaquete4 * tpaquete3]
  dataset[ , mult_paq_3_9 := tpaquete3 * tpaquete9]
  dataset[ , mult_paq_4_9 := tpaquete4 * tpaquete9]
  ...
  dataset[ , montos_inv2 := minversion2_pesos + minversion2_dolares]
  dataset[ , prom_inv2 := montos_inv2 / cinversion2]
  dataset[ , montos_inv := montos_inv1 + montos_inv2]
  dataset[ , montos_inv_pesos := minversion1_pesos + minversion2_pesos]
  dataset[ , montos_inv_dol := minversion1_dolares + minversion2_dolares]
  dataset[ , montos_inv_y_plazofijo := montos_inv + montos_plazofijo]
  dataset[ , montos_inv_y_plazofijo_pesos := montos_inv_pesos + mplazo_fijo_pesos]
  dataset[ , montos_inv_y_plazofijo_dol := montos_inv_dol + mplazo_fijo_dolares]
